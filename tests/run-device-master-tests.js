...
(async () => {
  ...
  // 見出しが無くても、機種名の右がまるごと1つの金額なら、これまでどおり読める
  const g4 = await parse('iPhone 17 128GB,145,200\nGalaxy S26,132,000');
  chk('⑥ 見出しが無くても「iPhone,145,200」は 145,200円 と読める',
    g4.list.length === 2 && g4.list[0].price === 145200 && g4.list[1].price === 132000,
    JSON.stringify(g4.list));
  const g5 = await parse('iPhone 17 128GB,145200\nGalaxy S26,132000');
  chk('⑥ 見出しが無く、割れてもいない一覧も、これまでどおり読める',
    g5.list.length === 2 && g5.list[0].price === 145200, JSON.stringify(g5.list));
