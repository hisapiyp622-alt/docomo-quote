...
window.DAKKAN_DATA = {
  ...
  carriers: [
    ...
    /* ---- 独自回線（関西で多い順） ---- */
    {
      ...
      monthly: { ht: null, ms: null },
      penalty: { ht: 4546, ms: null },
      removal: null,
      note: "戸建（ホームタイプ）1ギガ・即割ありの解約精算金。10ギガは5,537円、5ギガは5,019円。即割なしは2,082円。撤去費用は「引込線を含む撤去15,000円／回線終端装置のみの撤去は無料」で、どちらになるかは現地の設備によるため要確認。標準工事費を分割中の場合は残債を一括請求。マンションタイプは別料金のため要確認。",
      tel: "", url: "https://support.eonet.jp/inquiry/cancel/",
      src: "https://support.eonet.jp/usqa/other/3000272_14146.html （2026-07-31 確認）"
    },
