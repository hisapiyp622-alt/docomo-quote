...
window.DAKKAN_DATA = {
  ...
  carriers: [
    ...
    /* ---- フレッツ光（転用） ---- */
    {
      ...
      monthly: { ht: 5940, ms: 4070 },
      penalty: { ht: 4400, ms: 2200 },
      numberFee: null,
      note: "【回線利用料のみ／プロバイダ料は別】戸建=フレッツ光ネクスト ファミリー・スーパーハイスピードタイプ隼等の基本料金、マンション=マンションタイプ プラン1(いずれも割引前)。マンションはプラン2が3,520円、ミニ4,950円と建物により異なるため要確認。解約金は「光はじめ割ネクスト」適用時の額で、利用開始月から24カ月目末日までの解約で発生。同割引は2026年9月30日に新規受付終了。　【税表記】税込。flets-w.com に「本ホームページの料金・解約金等は特に記載のない限り税込です。」と明記(about_tax ページを実地確認)。掲載値をそのまま税込として採用し、1.1倍の換算はしていない。解約金4,400円／2,200円も同じ税込ルールの対象。",
    ...
    },
    {
      ...
      penalty: { ht: null, ms: null },
      numberFee: null,
      note: "【回線利用料のみ／プロバイダ料は別】戸建=ファミリー・ギガラインタイプ、マンション=マンション・ギガラインタイプ プラン1の割引前の標準額。現行は適用できる期間割引がない。マンションはプラン2が3,355円、ミニ4,455円と建物により異なるため要確認。解約金は公式の解約手続きページに金額の記載が一切なく戸建・マンションとも要確認(NTT東日本0120-116116)。推測額を伝えないこと。　【税表記】税込。flets.com の各料金ページ下部に「表示価格は、特別な記載がない限りすべて税込です。」と明記(ファミリー／マンション両ページおよび料金改定ページの実HTMLで確認)。掲載値をそのまま税込として採用し、1.1倍の換算はしていない。",
