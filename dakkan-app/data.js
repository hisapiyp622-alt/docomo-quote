...
window.DAKKAN_DATA = {
  ...
  carriers: [
    ...
    /* ---- フレッツ光（転用） ---- */
    {
      ...
      monthly: { ht: 4730, ms: 3575 },
      penalty: { ht: 4400, ms: 2200 },
      numberFee: null,
      note: "【回線利用料のみ／プロバイダ料は別】「光はじめ割ネクスト」(24カ月契約)を適用した1・2年目の額です。戸建=ファミリー・スーパーハイスピードタイプ隼 5,940円→4,730円、マンション=マンションタイプ プラン1 4,070円→3,575円。プロバイダ料は割引の対象外で別途掛かります。解約金も同割引の適用時の額で、24カ月目末日までの解約で発生（24カ月目末日での解約は不要）。同割引は2026年9月30日に新規受付終了。自動更新かどうかは公式に記載がないため要確認。マンションはプラン2が3,520円、ミニ4,950円と建物により異なるため要確認。　【税表記】税込。flets-w.com に「本ホームページの料金・解約金等は特に記載のない限り税込です。」と明記(about_tax ページを実地確認)。掲載値をそのまま税込として採用し、1.1倍の換算はしていない。解約金4,400円／2,200円も同じ税込ルールの対象。",
